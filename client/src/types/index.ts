...
export const categoryTransactionSchema = z.array(
  z.object({
    id: z.string(),
    date: z.string(),
    amount: z.string(),
    payee: z.object({ id: z.number(), name: z.string() }),
    category: z.object({ id: z.number(), name: z.string() }),
  })
);

export type CategoryTransactionType = z.infer<typeof categoryTransactionSchema>;
